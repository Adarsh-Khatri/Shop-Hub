...
export default class TotalShopPurchase extends Component {
    ...
    async fetchData() {
        ...
        let res = await get(`/totalPurchase/product/${id}`)
    ...
    render() {
        ...
        return (
            <div className="container my-5">
                <div className="row">
                    <h1 className='text-center lead fs-1'>TOTAL PURCHASES FOR PRODUCT : {id}</h1>
                    {
                                ...
                                totalPurchase.map(total =>
                                    <div className="row my-2">
                                        ...
                                        <h3 className='fw-bold'>
                                            Total Purchase : <span className='text-success'>{total.totalProductPurchase}</span>
                                        </h3>
                                    </div>
                                )
                            )
